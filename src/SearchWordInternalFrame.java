...
public class SearchWordInternalFrame extends JInternalFrame {
    ...
    public SearchWordInternalFrame() {
        super("Search Word");
        ...
        btnSearch.addActionListener(e -> {
                    if (tfWord.getText().length() > 0) {
                        ...
                        JOptionPane.showMessageDialog(SearchWordInternalFrame.this, "Please enter word from dictionary!", "Search Word", JOptionPane.ERROR_MESSAGE);
                }
        );
        ...
        btnFavorite.addActionListener(ae -> {
            if (tfWord.getText().length() > 0) {
                ...
                if (w != null) {
                    w.setFavorite(true);
                    JOptionPane.showMessageDialog(SearchWordInternalFrame.this, "Add word to favorite successfully!", "Favorite Word", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(SearchWordInternalFrame.this, "Word  Not Found. Please try again!", "Favorite Word", JOptionPane.INFORMATION_MESSAGE);
                }
            } else
                JOptionPane.showMessageDialog(SearchWordInternalFrame.this, "Please enter word from dictionary!", "Favorite Word", JOptionPane.ERROR_MESSAGE);
